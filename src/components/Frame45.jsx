...
function Frame45(){
return(
    <div className="w-[700px] h-[30px] justify-start items-center inline-flex mt-10">
    <div className="justify-start items-center flex">
    <div className="w-[30px] h-[30px] relative ml-10"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
    ...
    <div className="justify-start items-center flex">
    <div className="w-6 h-6 relative"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M8.59 16.59L13.17 12L8.59 7.41L10 6L16 12L10 18L8.59 16.59Z" fill="#06286E"/>
    </svg></div>
    ...
    <div className="text-center text-blue-950 text-lg font-semibold font-['Inter']">Relation and Functions</div>
    </div>
    </div>
    </div>
);
